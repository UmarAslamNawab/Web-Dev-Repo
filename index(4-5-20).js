...
// var rightNow = new Date();
// document.write(rightNow.toString() + "<br>");
...
// var rightNow = new Date();
// var theDay = rightNow.getDay(); //Mon
...
var msToday = today.getTime(); //current milliseconds
var msDoomsday = doomsday.getTime(); //future milliseconds 2035
